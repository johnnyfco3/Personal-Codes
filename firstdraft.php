...
<div class="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="#"><i class="fas fa-shopping-basket"></i></i>Inventory</a></li>
            <li><a href="#"><i class="fas fa-truck-loading"></i>Orders</a></li>
            <li><a href="#"><i class="fas fa-building"></i>Vendors</a></li>
